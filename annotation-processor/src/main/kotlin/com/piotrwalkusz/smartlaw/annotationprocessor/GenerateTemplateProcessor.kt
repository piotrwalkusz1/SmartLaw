...
class GenerateTemplateProcessor : AbstractProcessor() {
    ...
    private fun mapJavaTypeToKotlinType(javaType: TypeName): TypeName {
        ...
        if (javaType is ParameterizedTypeName && javaType.rawType == ClassName("java.util", "Map")) {
            return Map::class.asClassName().parameterizedBy(mapJavaTypeToKotlinType(javaType.typeArguments[0]), mapJavaTypeToKotlinType(javaType.typeArguments[1]))
        }
